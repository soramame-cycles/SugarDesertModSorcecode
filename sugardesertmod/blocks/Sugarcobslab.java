...
public class Sugarcobslab extends BlockSlab {
	...
	public Sugarcobslab() {
		...
		this.setRegistryName("sugar_cob_slab");
		this.setUnlocalizedName("sugar_cob_slab");
	...
	public Sugarcobslab(Material materialIn) {
		super(materialIn);
